...
export async function saveUserToDB(user: {
  ...
  try {
    if (!appwriteConfig.userCollectionId) {
      throw new Error("User Collection ID is not defined");
    }
    ...
    console.log("Error in saveUserToDB:", (error as Error).message);
    throw error;
  }
}
...
export async function getCurrentUser() {
  try {
    ...
    console.log("Error in getCurrentUser:", (error as Error).message);
    return null;
  }
}
